                    ...
                    <vs-card fixedHeight>
                        <vs-row>
                            <vs-col vs-lg="4" vs-sm="12">
                                <div>
                                    <img
                                        :src="'http://catco1.portfolios.spatiulab.com/images/products/' +  product.image" style="width:100%">
                                </div>
                            </vs-col>
...
<script>
    ...
    export default {
        ...
        methods: {
            getProducts() {
                axios.get("http://catco1.portfolios.spatiulab.com/api/new-products").then((result) => {
